...
class SignUpVC: UIViewController {
    ...
    func configureViewComponents() {
        ...
        let stackView = UIStackView(arrangedSubviews: [emailTextField,userNameTextField, fullNameTextField, passwordTextField,loginButton])
        stackView.axis = .vertical
        stackView.spacing = 10
        stackView.distribution = .fillEqually
        
        view.addSubview(stackView)
        stackView.anchor(top: plusPhotoBtn.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 20, paddingLeft: 40, paddingBottom: 0, paddingRight: 40, width: 0, height: 240)
    }
